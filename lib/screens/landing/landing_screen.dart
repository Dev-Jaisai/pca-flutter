...
class _LandingScreenState extends State<LandingScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text('Let\'s manage your academy 🏏', style: TextStyle(fontSize: 14, color: Colors.white.withOpacity(0.6))),
                        ],
                      ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text("Search players...", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 16)),
                            ],
                          ),
                        ),
                      ),
                  ...
                  // --- ALL FEATURES (Vertical List Style) ---
                  const Text('Manage Academy', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 0.5)),
                  const SizedBox(height: 16),

                  _buildGlassActionCard(icon: Icons.people, label: 'All Players List', color: Colors.purpleAccent, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const HomeScreen()))),
                  const SizedBox(height: 12),
  ...
  // --- REUSABLE GLASS CARD (Horizontal Style) ---
